...
BDR_AGENT_ROOT = REPO_ROOT / "bdr_agent"
SRC_ROOT = BDR_AGENT_ROOT / "src"
...
SKILL_PATHS = (
    Path("bdr_agent/skills/company-research/SKILL.md"),
    Path("bdr_agent/skills/outreach-composer/SKILL.md"),
)
